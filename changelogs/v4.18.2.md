...
- 新增活动 Agent 会话停止能力，并优化 stop 请求处理流程 ([#5380](https://github.com/AstrBotDevs/AstrBot/issues/5380))。
...
- 修复 aiocqhttp 适配器关闭阶段的稳定性问题，优化退出流程 ([#5412](https://github.com/AstrBotDevs/AstrBot/issues/5412))。
...
- 更新 README 内容并统一代码格式（ruff format）([#5375](https://github.com/AstrBotDevs/AstrBot/issues/5375))。
